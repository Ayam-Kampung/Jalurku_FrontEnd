<template>
  <footer class="pb-5 p-5 grid md:grid-cols-2 lg:grid-cols-3 gap-1 text-white bg-merah">
    ...
    <div>
      ...
      <div class="grid gap-5">
        <div class="flex gap-2 text-white">
          <svg xmlns="http://www.w3.org/2000/svg" class="flex-shrink-0" height="24px" viewBox="0 -960 960 960" width="24px" fill="#FFFFFF">
    ...
    <!-- Copyright -->
    <div class="flex items-center gap-2 col-span-full mt-10">
