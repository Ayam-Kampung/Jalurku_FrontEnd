    ...
    <div>
      ...
      <ul class="space-y-2">
        <li>
         ...
         <li>
          <RouterLink to="/playground" class="flex items-center gap-2 hover:text-gray-200">
            <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#FFFFFF">
              <path d="m256-240-56-56 384-384H240v-80h480v480h-80v-344L256-240Z" />
            </svg>
            Playground
        ...
        <li>
          <RouterLink to="/rencanaku" class="flex items-center gap-2 hover:text-gray-200">
            <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#FFFFFF">
              <path d="m256-240-56-56 384-384H240v-80h480v480h-80v-344L256-240Z" />
            </svg>
            Rencanaku
        ...
        <li>
          <RouterLink to="/jalurku" class="flex items-center gap-2 hover:text-gray-200">
            <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#FFFFFF">
              <path d="m256-240-56-56 384-384H240v-80h480v480h-80v-344L256-240Z" />
            </svg>
            JalurKu
        ...
        <li>
          <RouterLink to="/tentang" class="flex items-center gap-2 hover:text-gray-200">
            <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#FFFFFF">
              <path d="m256-240-56-56 384-384H240v-80h480v480h-80v-344L256-240Z" />
            </svg>
            Tentang
    ...
    <div>
      ...
      <div class="flex gap-5 items-center">
        ...
        <a href="https://www.youtube.com/@stematelpwt">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512" fill="#FFFFFF" class="w-6 h-6">
            <path
        ...
        <a href="https://www.instagram.com/stematelpwt/">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" fill="#FFFFFF" class="w-6 h-6">
            <path
