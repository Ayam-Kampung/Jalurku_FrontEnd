  ...
  <div class="min-h-screen flex bg-gray-50">
    ...
    >
      ...
      <section class="min-h-screen bg-gray-50 text-gray-800 p-6">
        <div
          class="max-w-7xl mx-auto bg-white rounded-xl shadow-md p-6 border border-gray-100"
        >
          <!-- Header -->
          <div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-4">
            ...
            <button
              ...
              class="flex items-center gap-2 bg-red-500 hover:bg-red-600 text-white px-6 py-3 rounded-lg transition-colors shadow-sm text-sm md:text-base"
            >
        ...
        <!-- Modal Tambah Pertanyaan (tetap sama) -->
        <transition name="fade">
          <div
            v-if="showAddModal"
